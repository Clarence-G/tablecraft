/** SVG path data for poker suits. ViewBox 0 0 512 512. Credit: skoll / game-icons.net CC BY 3.0 */
...
/** Inline SVG component for a poker suit. Uses `currentColor` for fill. */
