...
i18n
  ...
  .init({
    resources: {
      zh: { common: zhCommon, 'game-ui': zhGameUi, gomoku: zhGomoku, 'connect-four': zhConnectFour, hive: zhHive, uno: zhUno, battleship: zhBattleship, blackjack: zhBlackjack, 'texas-holdem': zhTexasHoldem, yahtzee: zhYahtzee, 'love-letter': zhLoveLetter, 'liar-bar': zhLiarBar },
      en: { common: enCommon, 'game-ui': enGameUi, gomoku: enGomoku, 'connect-four': enConnectFour, hive: enHive, uno: enUno, battleship: enBattleship, blackjack: enBlackjack, 'texas-holdem': enTexasHoldem, yahtzee: enYahtzee, 'love-letter': enLoveLetter, 'liar-bar': enLiarBar },
    },
    fallbackLng: 'zh',
    defaultNS: 'common',
    detection: {
